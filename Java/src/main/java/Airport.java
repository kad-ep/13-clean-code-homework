...
public class Airport {
    ...
    public static boolean areTransportMilitaryPlanes(List<MilitaryPlane> list){
        ...
        return isTransportMilitaryPlane;
    }

    public static boolean isNextPlaneMaxLoadCapacityIsHigherThanCurrent(List<Plane> list){
    ...
    public static boolean hasBombers(List<MilitaryPlane> list) {
    ...
    public static boolean hasUnclassifiedPlanes(List<ExperimentalPlane> list){
